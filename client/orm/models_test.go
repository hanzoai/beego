...
type Post struct {
	...
	Tags             []*Tag    `orm:"rel(m2m);rel_through(github.com/hanzoai/beego/v2/client/orm.PostTags)"`
}
...
type Permission struct {
	ID     int `orm:"column(id)"`
	Name   string
	Groups []*Group `orm:"rel(m2m);rel_through(github.com/hanzoai/beego/v2/client/orm.GroupPermissions)"`
}
...
var helpinfo = `need driver and source!
	...
	go Get -u github.com/hanzoai/beego/v2/client/orm
	...
	go test -v github.com/hanzoai/beego/v2/client/orm
	...
	go test -v github.com/hanzoai/beego/v2/pgk/orm
